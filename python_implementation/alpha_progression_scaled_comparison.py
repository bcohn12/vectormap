...
def save_baseplots_a_prog(C_mat, muscles_of_interest,
    ...
    for muscle in muscles_of_interest:
        ...
        for alpha in alpha_vals:
            ...
            title_str = "basemap_m" + str(muscle) + m_scale + 
                       " alpha"+str( alpha*.1 + 0.5 )
            plt.clim(0,1)
...
save_baseplots_a_prog(C_normal, muscles_of_interest, 
                        alpha_vals, grid_shape, 'normal')
save_baseplots_a_prog(C_scaled, muscles_of_interest, 
